    ...
    public class Encrypt
    {
        ...
        public static void EncryptFile(string fileName)
        {
            if (File.Exists(fileName))
            {
                ...
                string encryptedFileName = StringOperations.RemoveFileExtension(fileName) + ".ENC";
        ...
        public static void DecryptFile(string fileName)
        {
            if (File.Exists(fileName))
            {
                ...
                TimeSpan decryptionTime = finishTime - startTime;
                string decryptedFileName = StringOperations.CreateDecryptionFileName(fileName, decryptionTime.TotalMilliseconds);
                File.WriteAllText(decryptedFileName, decrypted);
            }
        }
